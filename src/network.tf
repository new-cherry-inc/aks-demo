module "azurerm_virtual_network_primary" {
  source = "github.com/new-cherry-inc/terraform-modules//azurerm/azurerm_virtual_network"
...
module "azurerm_subnet_kubernetes" {
  source = "github.com/new-cherry-inc/terraform-modules//azurerm/azurerm_subnet"
