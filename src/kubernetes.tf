module "azurerm_kubernetes_cluster_primary" {
  source = "github.com/new-cherry-inc/terraform-modules//azurerm/azurerm_kubernetes_cluster"
...
module "azurerm_kubernetes_cluster_node_pool_primary" {
  source = "github.com/new-cherry-inc/terraform-modules//azurerm/azurerm_kubernetes_cluster_node_pool"
